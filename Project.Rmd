...
As per the graphs, we can see that there is not a substantial change from having no internships to having one, but the difference between 0 to 2 or 3 is pretty large. Someone with 3 internships will make `r round(difference)` more on average, which is a `r difference/sal$avgSalary[4] * 100` % increase.
